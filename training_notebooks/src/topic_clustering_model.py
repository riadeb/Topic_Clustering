...
class Topic_clustering(object):
    ...
    def __init__(self,data_path="../TM-1-2019/self-dialogs.json",trained_weigths_folder ="./trained weigths/topic_clustering"):
        self.url_data = data_path
    ...
    def evaluation_test_set(self):
        ...
        for em in self.embedding_models:
            ...
            model.save_weights(self.trained_w_folder+"/%s.h5"%em)
